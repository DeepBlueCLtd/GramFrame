(function() {
  ...
  const COLOUR_MAPS = Object.freeze(["colour", "grey"]);
  ...
  function rememberPaintedLevels(instance, levels, frames, columns) {
  ...
  function createColourMapToggle(instance, bar, analysis) {
    const button2 = document.createElement("button");
    button2.type = "button";
    button2.className = "gram-frame-transport-btn gram-frame-colour-map";
    button2.title = "Grey shades";
    button2.setAttribute("aria-label", "Grey shades");
    button2.textContent = "Grey";
    const show = () => {
      button2.setAttribute("aria-pressed", analysis.colourMap === "grey" ? "true" : "false");
    };
    show();
    button2.addEventListener("mousedown", () => setFocusedInstance(instance));
    button2.addEventListener("click", () => {
