...
/**
 * Creates zoom control interface with zoom in/out and reset buttons
 * @param {HTMLElement} container - Container element for zoom controls
 * @param {Object} instance - GramFrame instance with zoom methods
...
export function createZoomControls(container, instance) {
  ...
  // Update zoom display when zoom changes (listen to state changes)
