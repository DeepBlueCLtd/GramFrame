 ...
 * @property {import('./utils/displayRange.js').DisplayRange} display - Contrast control positions (spec 171 FR-009, on every instance since #324); view state, never persisted
 */
