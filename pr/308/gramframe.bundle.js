(function() {
  ...
  function createRegionOverlay() {
    ...
    const resulting = document.createElementNS(SVG_NS$2, "rect");
  ...
  function readoutText({ rect: rect2, view, bounds, freqSpan, timeSpan }) {
    const text = (
      /** @type {SVGTextElement} */
    ...
    text.setAttribute("y", String(above - READOUT_FONT_SIZE < bounds.top ? view.y + view.height + READOUT_FONT_SIZE + 4 : above));
