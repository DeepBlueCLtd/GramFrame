(function() {
  ...
  function rectToRegion(viewport, spectrogramImage, rect) {
  ...
  function readoutText({ rect, bounds, freqSpan, timeSpan }) {
    ...
    text.setAttribute("y", String(above - READOUT_FONT_SIZE < bounds.top ? rect.y + rect.height + READOUT_FONT_SIZE + 4 : above));
