(function() {
  ...
  const COLOUR_MAPS = Object.freeze(["colour", "grey", "inferno"]);
  ...
  function createColourMapSelect(instance, bar, analysis) {
    const select = document.createElement("select");
    ...
    select.addEventListener("change", () => {
      const chosen = (
        /** @type {import('../audio/colourMap.js').ColourMapName} */
        select.value
      );
