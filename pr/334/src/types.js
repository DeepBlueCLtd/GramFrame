 ...
 * @property {import('./audio/colourMap.js').ColourMapName} colourMap - `colour` (the default table), `grey` (black-to-white, as a legacy renderer draws) or `inferno` (perceptually uniform)
 */
